        ...
        <section className="partners">
            <div className="container">
                ...
                <div className="partners-img">
                    <a target="_blank" rel="noreferrer" href="https://www.unb.br/">
                        <img src={unbLogo} className="unb-logo" alt="Universidade de Brasília" />
                    </a>
                    <a target="_blank" rel="noreferrer" href="http://www.fap.df.gov.br/">
                        <img src={fapLogo} alt="Fundação de Apoio à Pesquisa no Distrito Federal" />
                    </a>
                    <a target="_blank" rel="noreferrer" href="https://www.finatec.org.br/">
